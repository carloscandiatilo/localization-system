export const ValidationMessages = {
  ...
  DUPLICATE_RECORD: 'Este registro já existe no sistema. Por favor, diferencie-o!',
  RECORD_NOT_FOUND: 'Registro não encontrado.',
  RECORD_SOFT_DELETED: 'Este registro já foi excluído.',
  RECORD_SOFT_DELETE_SUCCESS: 'Registro excluído com sucesso!',
  RECORD_HARD_DELETE_SUCCESS: 'Registro excluído permanentemente.',
  RECORD_RESTORE_SUCCESS: 'Registro restaurado com sucesso.',
  ...
  RECORD_HARD_DELETE_SUCCESS_WITH_NAME: 'Registro com {nome} excluído permanentemente.',
};
